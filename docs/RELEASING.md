...
8. After code is on `master`, the workflow copies the generated package to `release/PersianDatePicker.pbiviz` and commits it when the binary changed.
